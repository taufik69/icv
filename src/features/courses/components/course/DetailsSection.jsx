...
export function DetailsSection({ id = 'details-title', title = 'COURSE DETAILS', details, placement, showPlacement }) {
  return (
    <section aria-labelledby={id} className="bg-surface-muted py-16 md:py-24">
      <Container>
        <Reveal className="text-center">
          <h2 id={id} className="text-3xl md:text-5xl">{title}</h2>
