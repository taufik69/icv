...
export function UnitsSection({ units, image }) {
  const tabs = [
    { id: 'core', label: units.coreLabel ?? 'Core Units', items: units.core },
    { id: 'elective', label: units.electiveLabel ?? 'Elective units', items: units.elective },
  ]
