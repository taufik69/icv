...
export const images = {
  ...
  carpentryCourse: pic('int-carpentry', [1400, 788], 'Carpentry students working timber at a workbench with their trainer', 700),
  stonemason: pic('int-stonemason', [1280, 854], 'Stonemason in safety glasses shaping a stone block', 640),
  whyStudents: { src: '/images/int-why-students.webp', width: 543, height: 481, alt: 'Group of cheerful students holding books' },
  collegeStudents: pic('wellbeing-students', [1500, 1000], 'Smiling group of ICV students holding books', 750),
